...
using SkiaSharp;
using ScalpAnalysis.src.Dashboard.Helper;
...
namespace ScalpAnalysis.src.Dashboard.Models
{
                ...
                case "SEBUM":
                    data = new ISeries[]
                    {
                        new LineSeries<int>
                        {
                            ...
                            Fill = null,
                            TooltipLabelFormatter = (chartPoint) => $"SEBUM : {chartPoint.PrimaryValue}"
                        }
                    };
                    OnPropertyChanged(nameof(data));
                ...
                case "PUSTULE":
                    data = new ISeries[]
                    {
                        new LineSeries<int>
                        {
                            ...
                            Fill = null,
                            TooltipLabelFormatter = (chartPoint) => $"PUSTULE : {chartPoint.PrimaryValue}"
                        }
                    };
                    OnPropertyChanged(nameof(data));
                ...
                case "MICROKERATIN":
                    data = new ISeries[]
                    {
                        new LineSeries<int>
                        {
                            ...
                            Fill = null,
                            TooltipLabelFormatter = (chartPoint) => $"MICROKERATIN : {chartPoint.PrimaryValue}"
                        }
                    };
                    OnPropertyChanged(nameof(data));
